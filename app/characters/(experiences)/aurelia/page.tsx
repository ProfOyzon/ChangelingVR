    ...
    <>
      <div id="wrapper">
        ...
        <div id="unlockedSite">
          ...
          <nav id="fileNav">
            <div>
              <button id="file1" className="cfButton">
                File 1
              </button>
            </div>
            <div>
              <button id="file2" className="cfButton">
                File 2
              </button>
            </div>
            <div>
              <button id="file3" className="cfButton">
                File 3
              </button>
            </div>
            <div>
              <button id="file4" className="cfButton">
                About me
              </button>
            </div>
            <div>
              <button id="fileAbout" className="cfButton">
                About Me
              </button>
            </div>
          </nav>
          ...
          <section id="caseFile">
            <div className="caseFileHead"></div>
            <div className="caseFileBody"></div>
          </section>
        </div>
      </div>
