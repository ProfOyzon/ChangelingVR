  ...
  return (
    <div className="mb-6 flex flex-wrap justify-center gap-6">
      {[...Array(20)].map((_, index) => (
        ...
        >
          <div className="bg-steel/50 h-40 w-full rounded-md backdrop-blur-sm"></div>
          <div className="w-full space-y-1 p-2">
            <div className="bg-steel/50 h-4 rounded-md backdrop-blur-sm"></div>
            <div className="bg-steel/50 h-10 rounded-md backdrop-blur-sm"></div>
          </div>
        </div>
      ))}
    </div>
