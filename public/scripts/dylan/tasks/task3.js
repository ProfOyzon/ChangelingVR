...
function initTask3(app, stats) {
  ...
  const catchBackground = Texture.from('/assets/images/experiences/dylan/catchBack.png');
  ...
  const douglas = Texture.from('/assets/images/experiences/dylan/douglasCatch.png');
  ...
  const dylanTexture = Texture.from('/assets/images/experiences/dylan/dylanCatch.png');
  ...
  const ballTexture = Texture.from('/assets/images/experiences/dylan/baseball.png');
