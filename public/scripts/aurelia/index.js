...
let caseFileData = {
  file1: {
	...
	<img src="/media/experiences/aurelia/polaroid_flat1.png" alt="BoogeyManImage">
  ...
  file2: {
	...
	<img id="caseImg" src="/media/experiences/aurelia/polaroid_flat2.png" alt="PlantImage">
  ...
  file3: {
	...
	<img id="caseImg" src="/media/experiences/aurelia/polaroid_flat3.png" alt="ShapeShiftCase">
  ...
  file4: {
	...
	<h2>My Abilities</h2>
	<img id="profile" src="/media/experiences/aurelia/pfp.PNG" alt="Logo">
	...
	<div id="call">
	    <img class="iconImage" src="/media/experiences/aurelia/phoneIcon.png" alt="phone">
	    <p class="CCInfo">555-824-2345</p>
	</div>
	<div id="address">
	    <img class="iconImage" src="/media/experiences/aurelia/HomeIcon.png" alt="home">
	    <p class="CCInfo">
		123 Fake Loc<br>
		New York, NY<br>
		1234-5678
	...
	<div id="mail">
	    <img class="iconImage" src="/media/experiences/aurelia/MailIcon.png" alt="email">
	    <p class="CCInfo">Awalker@Dreamwalkers.com</p>
	</div>
	<div id="other">
	    <img class="iconImage" src="/media/experiences/aurelia/Scryglass.png" alt="ScryglassIcon">
	    <p class="CCInfo">🜀 - 🜚 - 🝒 - 🜛 - 🝆 - 🜾</p>
	</div>
	</div> `,
  },
